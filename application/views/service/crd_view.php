                            ...
                            <div class="cell-xs-12 cell-sm-6 cell-md-12 widget-item">
                                <nav class="page-nav">
                                    <ul class="page-nav-list">
                                        ...
                                        <li class="active"><a href="<?php echo base_url('service/crd')?>">Credit Reference Databank (CRD) Data Submission</a></li>
                        ...
                        <article class="post-info">
                            <div class="post-info-body offset-top-30 offset-md-top-45">
                                <div class="service-body">
                                    <h3 class="text-bold">
                                        <a href="#">Credit Reference Databank (CRD) Data Submission</a>
                                    </h3>
                                    <hr class="hr-block hr-left hr-curious-red"/>
                                    <p>
                                        Safari Analytika also provides support to banks on addressing challenges relating to data submission to the
                                        Bank of Tanzania’s Credit Reference Databank (CRD) and Credit Reference Bureau’s (CRB’s).
                                    </p>
                                </div>
                            </div>
                        </article>
