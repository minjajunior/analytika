                            ...
                            <div class="cell-xs-12 cell-sm-6 cell-md-12 widget-item">
                                <nav class="page-nav">
                                    <ul class="page-nav-list">
                                        ...
                                        <li class="active"><a href="<?php echo base_url('about/social')?>">Social Responsibility</a></li>
                                    </ul>
                                </nav>
                            </div>
                        </div>
                        ...
                        <article class="post-info">
                            <div class="post-info-body offset-top-30 offset-md-top-45">
                                <div class="service-body">
                                    <h3 class="text-bold"><a href="#">Social Responsibility</a></h3>
                                    <hr class="hr-block hr-left hr-curious-red"/>
                                <p>
                                    We are committed to growing and developing the young upcoming data analysts in the field of data science and analytics.
                                    The primary channel for doing this is through the <b>Asante Foundation</b> a non-profit organisation set up by the firm founder
                                    to extend social and educational supports to those in need with a views to better improves their daily livelihood.
                                </p>
                                <p>
                                    Safari Analytika is committed to making a difference in Tanzania where its operating. Our social responsibility policy, which extends
                                    beyond our formal CSR commitments and monetary donations, focuses primarily on educational initiatives.
                                </p>
                                </div>
                            </div>
                        </article>
