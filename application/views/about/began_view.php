                            ...
                            <div class="cell-xs-12 cell-sm-6 cell-md-12 widget-item">
                                <nav class="page-nav">
                                    <ul class="page-nav-list">
                                        ...
                                        <li class="active"><a href="<?php echo base_url('about/began')?>">How Safari Analytika began</a></li>
                        ...
                        <article class="post-info">
                            <div class="post-info-body offset-top-30 offset-md-top-45">
                                <div class="service-body">
                                    <h3 class="text-bold"><a href="#">How Safari Analytika began</a></h3>
                                    <hr class="hr-block hr-left hr-curious-red"/>
                                <p>
                                    In 2017 as the financial world moving towards IFRS 9 adoption that was due on 1st January 2018, vast amounts of knowledge and expertise
                                    were required to design and build complete models for financial instruments at one of the local bank in Tanzania. A steering committee
                                    was formed headed by the bank CEO with the designing architecture commanded by <b>Edwin Urasa</b> a qualified model developer with vast experience
                                    in data analytics and credit scoring accumulated from his extensive work at Creditinfo an approved Credit reference bureau operates in Tanzania. The resulting models, the Expected Credit Loss (ECL) catered for different financial instruments from loan and advances, placements, government securities to off-balance sheet instruments, gave Safari “a Journey” its commencement both the basis for its name and its corporate beginnings.
                                </p>
                                </div>
                            </div>
                        </article>
